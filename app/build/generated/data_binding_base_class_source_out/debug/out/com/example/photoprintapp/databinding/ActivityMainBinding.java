...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnPrint,
      @NonNull Button btnSelectPhoto, @NonNull Button btnTakePhoto, @NonNull ImageView imageView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnPrint, btnSelectPhoto,
          btnTakePhoto, imageView, tvStatus);
    }
